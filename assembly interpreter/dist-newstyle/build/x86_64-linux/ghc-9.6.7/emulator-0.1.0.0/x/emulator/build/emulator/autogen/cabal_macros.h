...
/* package emulator-0.1.0.0 */
#ifndef VERSION_emulator
#define VERSION_emulator "0.1.0.0"
#endif /* VERSION_emulator */
#ifndef MIN_VERSION_emulator
#define MIN_VERSION_emulator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_emulator */
...
#define CURRENT_COMPONENT_ID "emulator-0.1.0.0-inplace-emulator"
